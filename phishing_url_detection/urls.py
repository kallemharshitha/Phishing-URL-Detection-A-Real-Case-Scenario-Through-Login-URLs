...
urlpatterns = [
    ...
    url(r'^Predict_URL_Type/$', remoteuser.Predict_URL_Type, name="Predict_URL_Type"),
    ...
    url(r'^View_URL_Type_Ratio/$', serviceprovider.View_URL_Type_Ratio, name="View_URL_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_URL_Type/$', serviceprovider.View_Prediction_Of_URL_Type, name="View_Prediction_Of_URL_Type"),
